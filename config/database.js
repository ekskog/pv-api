...
class Database {
  ...
  async initializeDefaultUsers() {
    try {
      const users = [
        { username: 'admin', email: 'admin@photovault.local', password: 'admin123', role: 'admin' },
        { username: 'user', email: 'user@photovault.local', password: 'user123', role: 'user' }
      ]
      ...
      console.error('Warning: Could not initialize default users:', error.message)
    }
  }
